...
class _CompressorTurbinePageState extends State<CompressorTurbinePage> {
  ...
  _CompressorTurbinePageState(this.metricUnit) : petrolTurboCalc = 0.0;
...
//  );
  ...
  CalculatorBrain calculateWithBrain = CalculatorBrain(
    compressorInducerSize: inducerCompressorMetric,
    compressorExducerSize: exducerCompressorMetric,
    turbineInducerSize: inducerTurbineMetric,
    turbineExducerSize: exducerTurbineMetric,
  );
  bool _enabled = true;
                            ...
                            setState(() {
                              ...
                              trimCompressorResult =
                                  calculateWithBrain.calculateCompressorTrim(
                                      inducerCompressorMetric,
                                      exducerCompressorMetric);
                              pressureCompressorResult = calculateWithBrain
                    ...
                    onStepPress: () {
                      timer =
                        ...
                        setState(() {
                          if (Decimal.parse(
                                  inducerTurbineMetric.toStringAsFixed(2)) <
                              Decimal.parse(kMaxTurbineInducerMetric
                                  .toStringAsFixed(2))) {
                            inducerTurbineMetric = inducerTurbineMetric +
                                stepValueCompressorTurbine;
                ...
                StepButton(
                    ...
                    onStep: () {
                      setState(() {
                        if ((Decimal.parse(
                                exducerTurbineMetric.toStringAsFixed(2)) >
                            (Decimal.parse(kMinTurbineExducerMetric
                                .toStringAsFixed(2))))) {
                          exducerTurbineMetric =
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                        AppLocalizations.of(context).translate(
                            'compressor_turbine_0070') //'COMPRESSOR',
                        ,
              ...
              DataTable(
                  ...
                  columns: [
                    ...
                    DataColumn(
                        ...
                        label: Text(
                          AppLocalizations.of(context).translate(
                              'compressor_turbine_0140') // 'Turbine',
                          ,
                          style: kResultLabelStyleWhite15_600,
                          textScaleFactor: textScaleFactorTc,
                        )),
